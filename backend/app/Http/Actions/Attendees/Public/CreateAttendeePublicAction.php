...
class CreateAttendeePublicAction extends BaseAction
{
    public function __construct(private readonly CreateAttendeeHandler $createAttendeeHandler)
    {
    }

    /**
     * Public endpoint: create attendee without requiring authentication.
     *
